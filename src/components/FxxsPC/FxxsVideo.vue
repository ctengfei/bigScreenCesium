<!--视频监控-->
<template>
  <div class="fxxsVideopc">
    <div class="fxxsVideopc-box" ref="mv1"></div>
    <div class="fxxsVideopc-box" ref="mv2"></div>
    <div class="fxxsVideopc-box" ref="mv3"></div>
    <div class="fxxsVideopc-box" ref="mv4"></div>
  </div>
</template>
