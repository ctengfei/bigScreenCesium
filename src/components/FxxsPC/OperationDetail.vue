<template>
  <div class="OperationDetailPC">
    <div class="time-info">
      <div style="text-align: center">时间：<span style="color: #52f3f6">{{ timeDate }}</span></div>
    ...
    <div class="operaDetailPC-title"><span></span><span>预报库容量</span></div>
    <div class="operaDetailPC-krEchart">
      <!-- 折线图 -->
      <DayLinkRatioCharts ref="linsInst" :echartsData="{option:krltjPC}"/>
    </div>
    <div class="operaDetailPC-title" style="margin-top: 0"><span></span><span>水位信息</span></div>
    <div class="operaDetailPC-krEchart">
      <!-- 折线图 -->
