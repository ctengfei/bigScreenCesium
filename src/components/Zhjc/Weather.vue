<template>
  <div class="weather">
     <div class="weather-item"  @click="openDialog()">
        <div class="weather-item-map">
            <dv-decoration-10 class="line1" style="width:540px;height:3px;" :color="['rgba(202, 244, 255, 0.5)','rgba(202, 244, 255, 0.5)']"/>
    ...
    <!-- <div class="weather-item">
        <div class="weather-item-title"><img src="../../assets/images/common/rightArrow.png"/><div class="titleBg"><span>卫星云图</span></div></div>
        <div class="weather-item-map">
            <dv-decoration-10 class="line1" style="240px;height:3px;" :color="['rgba(202, 244, 255, 0.5)','rgba(202, 244, 255, 0.5)']"/>
            <dv-decoration-10 class="line2" style="width:240px;height:3px;" :color="['rgba(202, 244, 255, 0.5)','rgba(202, 244, 255, 0.5)']" />
            <div class="mapbox"></div>
        </div>
    </div> -->
    <!-- <div class="weather-item">
        <div class="weather-item-title"><img src="../../assets/images/common/rightArrow.png"/><div class="titleBg"><span>雷达回波图</span></div></div>
        <div class="weather-item-map">
            <dv-decoration-10 class="line1" style="240px;height:3px;" :color="['rgba(202, 244, 255, 0.5)','rgba(202, 244, 255, 0.5)']"/>
            <dv-decoration-10 class="line2" style="width:240px;height:3px;" :color="['rgba(202, 244, 255, 0.5)','rgba(202, 244, 255, 0.5)']" />
     ...
     <PlayImageDialogVue  :imgListAll="imgListAll" dialogWidth="100%" ref="imageDialog" @imageTimeChange='handleImageChange'></PlayImageDialogVue>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    startPlayImage(){
      ...
      playimage.resetData()
      playimage.CanvasPlayFrames('110%')
      playimage.play()
