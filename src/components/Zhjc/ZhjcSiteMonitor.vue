<template>
  <div class="zhjcsiteM" id="map">
    <div class="zhjcsiteM-search">
      <!-- <content-tab :tabList="tabList" :tabIndex="tabIndex" @tabChange="handleTabChange" class="zhjcsiteM-tab"></content-tab> -->
      <el-input v-model="tableSearchValue" placeholder="请输入搜索关键字" @input="getDataBySearch"></el-input>
      <div class="search-line"></div>
      <div class="search-arrow"></div>
    </div>
    <content-radio :radioList="radioList" :radioIndex="radioIndex" class="zhjcsiteM-raido"
                   @radioChange="handleRadioChange"></content-radio>
    <div class="tablebox">
      <dv-scroll-board class="mytableBox" :config="config" @click="handleRowClick"/>
    </div>
...
<script>
import ContentRadio from '../ContentRadio.vue';
import ContentTab from '../ContentTab.vue';
import Hls from 'hls.js'
import DPlayer from 'dplayer';

export default {
  name: "zhjcSiteMonitor",
  props: {},
  components: {
    ContentTab,
    ContentRadio
