 ...
 */
 ...
 import Vue from "vue";
 import Label from "./siteIndex.vue";
 let WindowVm = Vue.extend(Label);
 export default class SiteBubble {
     
     constructor(val) {
       console.log('SiteBubble')
       console.log(val)
         this.viewer = val.viewer;
        //  this.height = val.height;
         this.position = val.position._value;
         let title = val.monitoItems.data.name;
         let type = val.monitoItems.data.type;
         let itemData = val.monitoItems.data
